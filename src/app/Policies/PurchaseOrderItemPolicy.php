...
class PurchaseOrderItemPolicy
{
    ...
    {
        return $user->can('view_any_purchase::order::item');
    }
    ...
    {
        return $user->can('view_purchase::order::item');
    }
    ...
    {
        return $user->can('create_purchase::order::item');
    }
    ...
    {
        return $user->can('update_purchase::order::item');
    }
    ...
    {
        return $user->can('delete_purchase::order::item');
    }
    ...
    {
        return $user->can('delete_any_purchase::order::item');
    }
     ...
     */
    public function replicate(User $user, PurchaseOrderItem $purchaseOrderItem): bool
    {
